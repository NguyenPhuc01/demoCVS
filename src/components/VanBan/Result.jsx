...
export default function Result({ result, type }) {
  ...
  const resultOptions = {
    ...
    "so-khai-sinh": <SoKhaiSinh data={data2.info} />,
...
function SoKhaiSinh({ data }) {
  const {
    ...
    father_ethnicity,
    father_ethnicity_confidence,

    father_name,
    father_name_confidence,
    father_nationality,
    father_nationality_confidence,
    gender,
    gender_confidence,
    ...
    mother_address,
    mother_ethnicity_confidence,
    mother_nationality_confidence,
    ...
    registrant_id,
    registrant_name,
    registrant_name_confidence,
    sign_name,
    mother_ethnicity,
    mother_nationality,
    sign_name_confidence,
    registrant_id_confidence
  } = data || {};
  ...
  return (
    <>
      ...
      <Field
        name="Người được đăng ký khai sinh"
        value={name}
        confidence={name_confidence}
      />
      <Field name="Ngày đăng ký" value={date} confidence={date_confidence} />
      <Field name="Ngày sinh" value={dob} confidence={dob_confidence} />
      <Field name="Giới tính" value={gender} confidence={gender_confidence} />
      <Field
        name="Dân tộc"
      ...
      <Field
        name="Dân tộc mẹ"
        value={mother_ethnicity}
        confidence={mother_ethnicity_confidence}
      />
      <Field
        name="Quốc tịch mẹ"
      ...
      <Field
        name="Dân tộc cha"
        value={father_ethnicity}
        confidence={father_ethnicity_confidence}
      />
      <Field
        name="Quốc tịch cha"
      ...
      />
      <Field
        name="Người đi khai sinh"
        value={registrant_name}
        confidence={registrant_name_confidence}
      />
      <Field
        name="Giấy tờ tùy thân"
        value={registrant_id}
        confidence={registrant_id_confidence}
      />
      <Field
        name="Người ký giấy khai sinh"
        value={sign_name}
        confidence={sign_name_confidence}
      />
    </>
  );
}
